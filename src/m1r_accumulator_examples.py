...
#            for _ in range(n):
#        What does the   _   (underscore) mean?     ignore the loop variable
#
...
#        and one is WRONG.  Which is the WRONG one? The second one. It updates x by diameter AND by a multiple of k.
#
#              x = starting_point.x
#              for k in range(n):
